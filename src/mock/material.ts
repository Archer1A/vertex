...
export const materialProperties: PropertyType[] = [
  { id: 'material_code', objectTypeId: MATERIAL_OBJECT_TYPE_ID, apiName: 'materialCode', displayName: 'Material Code', description: '物料唯一编码', baseType: 'string', required: true, isPrimaryKey: true, searchable: true, sortable: true, filterable: true ,showInNode:true},
  ...
  { id: 'material_type', objectTypeId: MATERIAL_OBJECT_TYPE_ID, apiName: 'materialType', displayName: 'Material Type', description: '物料类型：成品/半成品/原材料', baseType: 'enum', searchable: true, sortable: true, filterable: true,showInNode:true },
...
export const bomLineProperties: PropertyType[] = [
  ...
  { id: 'quantity_per', objectTypeId: BOM_LINE_OBJECT_TYPE_ID, apiName: 'quantityPer', displayName: 'Quantity Per', description: '单位父物料所需子物料数量', baseType: 'number', required: true, sortable: true, filterable: true,showInNode:true},
...
export const materialDemandProperties: PropertyType[] = [
  ...
  { id: 'demand_date', objectTypeId: MATERIAL_DEMAND_OBJECT_TYPE_ID, apiName: 'demandDate', displayName: 'Demand Date', description: '需求到货/可用日期（最早到达时间）', baseType: 'date', sortable: true, filterable: true,showInNode:true },
  ...
  { id: 'status', objectTypeId: MATERIAL_DEMAND_OBJECT_TYPE_ID, apiName: 'status', displayName: 'Status', description: '状态：未满足/已下生产/已采购/已满足', baseType: 'enum', searchable: true, sortable: true, filterable: true ,showInNode:true}
]
