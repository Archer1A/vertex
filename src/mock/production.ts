...
export const productionOrderInstances: ObjectInstance[] = [
  { id: 'inst_po_001', objectTypeId: PRODUCTION_ORDER_OBJECT_TYPE_ID, properties: { production_order_number: 'PO-2024-001', quantity: 50, planned_start_date: '2024-08-01', planned_end_date: '2024-09-15', status: '生产中' } },
  { id: 'inst_po_002', objectTypeId: PRODUCTION_ORDER_OBJECT_TYPE_ID, properties: { production_order_number: 'PO-2024-002', quantity: 30, planned_start_date: '2024-08-01', planned_end_date: '2024-09-15', status: '已排产' } },
  { id: 'inst_po_003', objectTypeId: PRODUCTION_ORDER_OBJECT_TYPE_ID, properties: { production_order_number: 'PO-2024-003', quantity: 100, planned_start_date: '2024-10-01', planned_end_date: '2024-12-01', status: '计划' } }
]
