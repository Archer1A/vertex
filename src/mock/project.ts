...
export const projectProperties: PropertyType[] = [
  ...
  { id: 'customer_name', objectTypeId: PROJECT_OBJECT_TYPE_ID, apiName: 'customerName', displayName: 'Customer Name', description: '客户名称', baseType: 'string', searchable: true, sortable: true, filterable: true },
  { id: 'project_status', objectTypeId: PROJECT_OBJECT_TYPE_ID, apiName: 'projectStatus', displayName: 'Project Status', description: '项目状态，如需求确认/生产中/已交付', baseType: 'enum', searchable: true, sortable: true, filterable: true },
...
export const projectLineItemProperties: PropertyType[] = [
  ...
  { id: 'requested_delivery_date', objectTypeId: PROJECT_LINE_ITEM_OBJECT_TYPE_ID, apiName: 'requestedDeliveryDate', displayName: 'Requested Delivery Date', description: '客户要求交付日期', baseType: 'date', sortable: true, filterable: true },
  ...
  { id: 'production_status', objectTypeId: PROJECT_LINE_ITEM_OBJECT_TYPE_ID, apiName: 'productionStatus', displayName: 'Production Status', description: '生产状态：待排产/生产中/已完成', baseType: 'enum', searchable: true, sortable: true, filterable: true },
